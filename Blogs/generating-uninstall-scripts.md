...
- Download the uninstaller from [GitHub](https://github.com/KaeIan/Generate-Uninstaller)
...
![Generate Example](Assets/generating-uninstall-scripts/generate-example.png)
